...
@class POCCurrentWeather, POCCurrentWeatherCompanion, POCKotlinArray<T>, POCKotlinException, POCKotlinIllegalStateException, POCKotlinNothing, POCKotlinRuntimeException, POCKotlinThrowable, POCKotlinx_serialization_coreSerialKind, POCKotlinx_serialization_coreSerializersModule, POCWeatherResponse, POCWeatherResponseCompanion, UIViewController;
...
- (instancetype)initWithTemperature:(double)temperature windSpeed:(double)windSpeed __attribute__((swift_name("init(temperature:windSpeed:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) POCCurrentWeatherCompanion *companion __attribute__((swift_name("companion")));
- (POCCurrentWeather *)doCopyTemperature:(double)temperature windSpeed:(double)windSpeed __attribute__((swift_name("doCopy(temperature:windSpeed:)")));
...
- (instancetype)initWithCurrentWeather:(POCCurrentWeather * _Nullable)currentWeather __attribute__((swift_name("init(currentWeather:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) POCWeatherResponseCompanion *companion __attribute__((swift_name("companion")));
- (POCWeatherResponse *)doCopyCurrentWeather:(POCCurrentWeather * _Nullable)currentWeather __attribute__((swift_name("doCopy(currentWeather:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) POCCurrentWeather * _Nullable currentWeather __attribute__((swift_name("currentWeather")));
@end
...
*/
- (void)fetchCurrentWeatherLatitude:(double)latitude longitude:(double)longitude completionHandler:(void (^)(POCCurrentWeather * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchCurrentWeather(latitude:longitude:completionHandler:)")));
@end
...
@interface POCMainViewControllerKt : POCBase
